...
import { Check, Download, Share2, Undo2, Redo2, ChevronDown, Sun, Moon, Plus } from "lucide-react";
import type { Floor } from "@/lib/studio";
    ...
    >
      ...
      {minimal ? (
        ...
        <>
          ...
          <button className="flex items-center gap-1.5 px-2 h-8 rounded-lg text-[13px] font-medium transition-colors" style={{ color: "var(--st-text)" }}
            onMouseEnter={(e) => (e.currentTarget.style.background = "var(--st-hover)")}
            onMouseLeave={(e) => (e.currentTarget.style.background = "transparent")}
          >
            {projectName}
            <ChevronDown size={13} style={{ color: "var(--st-text-3)" }} />
          </button>
